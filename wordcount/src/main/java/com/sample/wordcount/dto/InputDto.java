 ...
 * @see com.sample.wordcount.controller.WordCountRestController#getSummary(InputDto, String, Integer)
 * 
...
public class InputDto {
	...
	@Schema(name = "Input List of Words", example = "[ \"word_1\", \"word_2\", [\"inner_list_1\", \"inner_list_2\"] ]"  )
	@NotNull (message = ErrorConstants.INPUT_LIST_NULL_MSG)
	@NotEmpty(message = ErrorConstants.INPUT_LIST_EMPTY_MSG)
	List<String> list;

	/*
	 * public InputDto() { super(); }
	 * 
	 * public InputDto(List<String> list) { super(); this.list = list; }
	 * 
